...
(function ($) {
  ...
  // Simple Bar
  // const element = $("#sidebar_menus, #scrollModal")[0];
  ...
  $("#data-table, .data-table").DataTable({
    ...
    dom: "<'grid grid-cols-12 gap-5 px-6 mt-6'<'col-span-12 lg:col-span-4 flex justify-center lg:justify-start'l><'col-span-12 lg:col-span-8 flex justify-center lg:justify-end'f><'#pagination.flex items-center'>><'min-w-full't><'flex justify-end items-center'p>",
    paging: true,
    ordering: true,
    info: false,
    searching: true,
