                          ...
                          <div class="row">
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="user_fname" name="user_fname" value="<?=$tl[0]["user_fname"]?>" placeholder="Enter First Name" required>
                              </div>
                            </div>
                            <div class="col-sm-3">
                              <div class="form-group">
                                <label for="user_lname">User Last Name</label>
                                <input type="text" class="form-control" id="user_lname" name="user_lname" value="<?=$tl[0]["user_lname"]?>"  placeholder="Enter Last Name" required>
                              </div>
                            </div>
                            <div class="col-sm-3">
                              <div class="form-group">
                                <label for="user_mail">User Email Address</label>
                                <input type="email" class="form-control" id="user_mail" name="user_mail" value="<?=$tl[0]["user_mail"]?>"  placeholder="Enter Email Address" required readonly="true" >
                              </div>
                            </div>
                            <div class="col-sm-3">
                              <div class="form-group">
                                <label for="user_phone">User Phone Number</label>
                                <input type="number" class="form-control" id="user_phone" name="user_phone" value="<?=$tl[0]["user_contact"]?>"  placeholder="Enter Phone Number" required>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="user_city" id="user_city" style="width: 100%;" onchange="get_zone(this,0);">
                                  ...
                                  <?php  
                                    foreach ($this->tl_detail["city_data"] as $city_list) {
                                      if ($city_list["id"] == $tl[0]["city_id"]) {
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="user_zone" id="user_zone" style="width: 100%;" onchange="get_manager_and_area(this,0);">
                                  ...
                                  <?php  
                                    foreach ($this->tl_detail["zone_info"] as $zone_list) {
                                      if ($zone_list["id"] == $tl[0]["zone_name"]) {
                                        $class_tag ='selected="selected"';
                                      }else{
                                        $class_tag ='';
                                      }
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="user_area" id="user_area" style="width: 100%;">
                                  ...
                                  <?php  
                                  foreach ($this->tl_detail["area_info"] as $area_list) {
                                    if ($area_list["id"] == $tl[0]["area_name"]) {
                                      $class_tag ='selected="selected"';
                                    }else{
                                      $class_tag ='';
                                    }
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="manager" id="manager" style="width: 100%;" required="true">
                                  <option selected="selected" value="0">Select Zone first</option>
                                  <?php  
                                    foreach ($this->tl_detail["manager"] as $manager_list) {
                                      if ($manager_list["user_id"] == $tl[0]["underid"]) {
                                        $class_tag ='selected="selected"';
                                      }else{
                                        $class_tag ='';
                                      }
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="supervisor" id="supervisor" style="width: 100%;" required="true">
                                  <?php  
                                    foreach ($this->tl_detail["supervisor"] as $supervisor_list) {
                                      if ($supervisor_list["user_id"] == $tl[0]["underid"]) {
                                        $class_tag ='selected="selected"';
                                      }else{
                                        $class_tag ='';
                                      }
                                  ?>
                                    <option value="<?=$supervisor_list["user_id"]?>" <?=$class_tag?>><?=$supervisor_list["user_fname"]." ".$supervisor_list["user_lname"]?></option>
                                  <?php
                                    }
                                  ?>
                              ...
                              <div class="col-sm-3">
                                <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="user_locality" id="user_locality" style="width: 100%;">
                                    <option selected="selected" value="0">Select Zone first</option>
                                    <?php  
                                    foreach ($this->tl_detail["locality_info"] as $area_list) {
                                      if ($area_list["id"] == $tl[0]["localities_name"]) {
                                        $class_tag ='selected="selected"';
                                      }else{
                                        $class_tag ='';
                                      }
                                  ?>
                                    <option value="<?=$area_list["id"]?>" <?=$class_tag?>><?=$area_list["locality"]?></option>
                                  <?php
                                    }
                                  ?>
                                  </select>
