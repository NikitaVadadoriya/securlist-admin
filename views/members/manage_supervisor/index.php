  ...
  <section class="content">
   ...
   <div class="col-md-12">
    <div class="card card-default">
      ...
      <!-- form start -->
      <form  action="<?=URL?><?=str_replace(' ', '', $this->utype)?>/manage_supervisor/add" method="post">
        <div class="card-body">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select class="form-control select2" name="user_zone" id="user_zone" style="width: 100%;" onchange="get_manager_and_area(this,0);">
                  <option selected="selected" value="0">Select City first</option>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select class="form-control select2" name="user_area" id="user_area" style="width: 100%;">
                  ...
                  <?php  
                    foreach ($this->manager_list["area"] as $area_list) {
                  ?>
      ...
      <div class="card-body">
       <table id="datatable1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <?php  
          foreach ($this->manager_list["user_data"] as $supervisor) {
            $i=1;
            ?>
            <tr>
              <td><?=$i?></td>
              <td><?php echo $supervisor["user_fname"] . " " . $supervisor["user_lname"]?></td>
              <td><?php echo $supervisor["underfname"] . " " . $supervisor["underlanme"]?></td>
              <td><?=$supervisor["user_mail"]?></td>
              <td><?=$supervisor["user_contact"]?></td>
              <td>
                <?php  
                if (isset($supervisor["zone_name"])) {
                  echo $supervisor["zone_name"];
                }else{
                  echo "Not Assgined To Any Area";
                }
                ?>
              </td>
              <td>
                <span class="badge bg-success">Punagam</span>
                <span class="badge bg-success">Katargam</span>
                <span class="badge bg-success">Ved</span>
                <span class="badge bg-success">Citylight</span>
                <!-- <?php  
                if (isset($supervisor["area_name"])) {
                  echo $supervisor["area_name"];
                }else{
                  echo "Not Assgined To Any Area";
                }
                ?> -->
              ...
              ?></td>
              <td>
                <a class="btn btn-primary btn-sm" href="<?=URL?><?=str_replace(' ', '', $this->utype)?>/manage_supervisor/edit/<?=urlencode(base64_encode($supervisor["user_mail"]))?>" data-toggle="tooltip" title="Edit User">
                  <i class="fas fa-edit"></i>
                </a>
               <!--  <a class="btn btn-danger btn-sm" href="<?=URL?><?=str_replace(' ', '', $this->utype)?>/manage_supervisor/delete" data-toggle="tooltip" title="Deactivate User">
