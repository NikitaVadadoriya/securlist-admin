                        ...
                        <div class="auth-box h-full flex flex-col justify-center">
                            ...
                            <div class="card rounded-md bg-white dark:bg-slate-800 shadow-base">
                                <div class="card-body flex flex-col p-6">
                                    <form class="space-y-4" action="<?=URL . admin_link ?>/2fa/update_2fa"
                                        method="post">
                                        <div class="col-lg-12">
                                            <p><b>Step 1.</b> Install this app from
                                                <a target="_blank"
                                            ...
                                            <p><b>Step 3.</b> <strong>Manually add Account:</strong><br>Account
                                                Name: <strong class="text-head">Securlists-Admin</strong> <br> Key:
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 pt-4">
                                                ...
                                                <button type="submit" class="btn btn-primary mt-2">Confirm 2FA</button>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
