...
<html lang="en" dir="ltr" class="light">
    ...
    <body class="font-inter skin-default">
                    ...
                    <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                        <div class="auth-box h-full flex flex-col justify-center">
                            ...
                            <div class="text-center 2xl:mb-10 mb-4">
                                <h4 class="font-medium">Admin Reset Password</h4>
                            ...
                            <form class="space-y-4" action="<?=URL . admin_link?>/reset_password/change_password"
                                ...
                                <button class="btn btn-dark block w-full text-center" type="submit">Change
                                    Password</button>
                            </form>
                        </div>
        ...
        <script src="<?=URL?>/views/admin/reset_password/js/default.js"></script>
    </body>
