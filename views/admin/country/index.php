        ...
        <div class="card xl:col-span-2 mb-4">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Add New Country</div>
                    </div>
                </header>
                <div class="card-text h-full ">
                    <form class="space-y-4" method="post" id="add_country_form"
                        action="<?=URL . admin_link?>/country/add_country">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                            ...
                            <div class="input-area relative">
                                <label for="dial_code" class="form-label">Dial Prefix Code</label>
                                <input type="text" class="form-control" name="dial_code" id="dial_code"
                                    placeholder="Enter Dial Prefix Code">
                            </div>
                            <div class="input-area relative">
                                ...
                                <table
                                    ...
                                    <thead class=" bg-slate-200 dark:bg-slate-700">
                                        <tr>
                                            ...
                                            <th scope="col" class="table-th">Dial Prefix Code</th>
                                            <th scope="col" class="table-th">ISO Code</th>
                                            <th scope="col" class="table-th">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody
                                        class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                        <?php foreach ($country as $index => $data) { ?>
                                        <tr data-no.="<?= $index + 1 ?>"
                                            data-cid="<?= $this->encrypt_string($data['id']) ?>"
                                            data-country="<?= $data['country_name']; ?>"
                                            data-dial-code="<?= $data['dial_code']; ?>"
                                            data-code="<?= $data['code']; ?>">
                                            ...
                                            <td class="table-td ">
                                                <?php
                                                    if($data['isDeleted'] == 1) {
                                                        ?>
                                                <button type="button"
                                                    onclick="handleBtnClick('<?= $this->encrypt_string($data['country_name']) ?>', 1)">
                                                    Activate
                                                </button>
                                                <?php
                                                    } else {
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    <button class="action-btn" type="button"
                                                        onclick="handleBtnClick('<?= $this->encrypt_string($data['country_name']) ?>', 2)">
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="country_modal" tabindex="-1" aria-labelledby="country_modal" aria-hidden="true">
    <!-- BEGIN: Modal -->
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <div
                    ...
                    <h4 class="text-xl font-medium text-white dark:text-white capitalize header">
                        Type "YES" to Delete this Country
                    </h4>
                    <button type="button"
                ...
                <!-- Modal body -->
                <form method="post" action="<?=URL . admin_link?>/country/change_country_status">
    ...
    <div class="modal-dialog relative w-auto pointer-events-none">
        <div
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <form id="EditCountryData">
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 gap-7">
                            <div class="input-area relative">
                                <label for="EditcountryName" class="form-label">Country</label>
                                <input type="text" class="form-control" name="countryName" id="EditcountryName"
                                    placeholder="Enter Country Name">
                            </div>
                            <div class="input-area relative">
                                <label for="Editcode" class="form-label">Dial Prefix Code</label>
                                <input type="text" class="form-control" name="code" id="Editcode"
                                    placeholder="Enter Dial Prefix Code">
                            </div>
                            <div class="input-area relative">
                                <label for="EditisoCode" class="form-label">ISO Code</label>
                                <input type="text" class="form-control" name="isoCode" id="EditisoCode"
                                    placeholder="Enter ISO Code">
                            </div>
                        </div>
                    </div>
