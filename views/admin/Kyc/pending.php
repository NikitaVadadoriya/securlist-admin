        ...
        <div class="card xl:col-span-2 mb-4">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Filter Pending KYC Request</div>
                        <small>You have the ability to filter pending KYC request based on the business name, and date
                            range.</small>
                    </div>
                </header>
                <div class="card-text h-full ">
                    ...
                    ?>
                            ...
                            <div class="input-area relative">
                                <label for="date_range" class="form-label">Date Range (Updated At)</label>
        ...
        <div class="grid xl:grid-cols-1 grid-cols-1 gap-6">
            <div class="card">
                <header class="card-header">
                    <h4 class="card-title">Pending Business KYC Lists</h4>
                </header>
                ...
                <form method="post" action="<?= URL . admin_link ?>/kyc/reject_kyc">
                    ...
                    <div
                        ...
                        <button type="submit" name="yes" id="confirm_btn"
                            class="btn inline-flex justify-center text-white bg-black-500">Reject</button>
                    </div>
                </form>
            </div>
        </div>
