            ...
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        ...
                        <small>You have the ability to filter KYC request based on the business name, and date
                            range.</small>
                    </div>
                </header>
                                ...
                                <table
                                    ...
                                    <thead class="bg-slate-200 dark:bg-slate-700">
                                        <tr>
                                            ...
                                            <th scope="col" class="table-th">Insurance expire</th>
                                            ...
                                            <th scope="col" class="table-th">Reject Reason</th>
                                            <th scope="col" class="table-th">Approved Date</th>
                                            <th scope="col" class="table-th">Business status</th>
                                            <th scope="col" class="table-th bg-slate-200 dark:bg-slate-700">Request
                                                Status
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody
                                        ...
                                        <tr data-no.="<?=$index+1?>" data-kid="<?= $data['id'] ?>"
                                            data-bid="<?= $data['business_id'] ?>">
                        ...
                        if($data['licence_proof']) {
                            ?>
                                                <img src="<?=api_url . $data['licence_proof']?>" alt="Licence Proof"
                                                    class="data-table-img w-full h-full cursor-pointer" height="100"
                                                    width="100" onclick="openModal(this)">
                                                <?php
                        } else {
                            echo '-';
                        }
                                            ...
                                            <td class="table-td">
                                                <?= $data['insurance_expiry'] ? date('d/m/Y', strtotime($data['insurance_expiry'])) : "-"?>
                                            </td>
                                            ...
                                            if($data['website']) {
                                                ?>
                                                <a href="<?=$data['website']?>" target="_blank" class="text-primary-500"
                                            ...
                                            <td class="table-td">
                                                <?= date('d/m/Y', strtotime($data['updatedAt'])) ?>
                                            </td>
                                            <td class="table-td">
                                            ...
                                            <td class="table-td">
                                                <?= $data['apprvoed_date'] ? date('d/m/Y', strtotime($data['apprvoed_date'])) : "-"?>
                                            </td>
                                            <td class="table-td bg-white">
                                                <?php
                                                if($data['business_status'] == 0) {
                                                    echo '<span class="text-success-500">Active</span>';
                                                } elseif ($data['business_status'] == 1) {
                                                    echo '<span class="text-danger-500">Blocked</span>';
                                                } else {
                                                    echo '-';
                                                }
                                            ?>
                                            <td class="table-td bg-white">
                                                ...
                                                if($data['is_approved'] == 0) {
                                                    echo '<span class="text-primary-500">Pending</span>';
                                                } elseif ($data['is_approved'] == 1) {
                                                    echo '<span class="text-success-500">Approved</span>';
                                                } elseif ($data['is_approved'] == 2) {
                                                    echo '<span class="text-danger-500">Rejected</span>';
                                                } else {
                                                    echo '-';
                                                }
                                            ?>
