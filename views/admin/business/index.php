        ...
        <div class="card xl:col-span-2 mb-4">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Registered Business</div>
                        <small>You have the ability to filter registered Businesses based on the busness name and date
                            range.</small>
                    </div>
                </header>
                <div class="card-text h-full ">
                    <form id="business_filter_form" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                            <div class="input-area relative">
                                <label for="business" class="form-label">Business name</label>
                                <select name="business_id" id="business" class="select2 form-control w-full mt-2 py-2">
                                ...
                                <table
                                    ...
                                    <thead class="bg-slate-200 dark:bg-slate-700">
                                        <tr>
                                            ...
                                            <th scope="col" class="table-th">Business Email</th>
                                            <th scope="col" class="table-th">Address</th>
                                            <th scope="col" class="table-th">Pincode</th>
                                            ...
                                            <th scope="col" class="table-th">KYC status</th>
                                            <th scope="col" class="table-th">Registration Date</th>
                                            <th scope="col" class="table-th">Total Credit</th>
                                            <th scope="col" class="table-th">Total Debit</th>
                                            <th scope="col" class="table-th">Current Balance</th>
                                            <th scope="col" class="table-th bg-slate-200 dark:bg-slate-700">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody
                                        class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                        <?php foreach ($this->today_registered as $index => $data) { ?>
                                        <tr
                                            class="even:bg-slate-50 dark:even:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700">
                                            <td class="table-td bg-white sticky" style="left: 0;"><?=$index+1?>
                                            ...
                                            <td class="table-td">
                                                ...
                                                if($data['business_profile']) {
                                                    ?>
                                                <img src="<?=api_url . $data['business_profile']?>" alt="Profile"
                                            ...
                                            <td class="table-td"><?=$data["business_email"]?></td>
                                            <td class="table-td"><?=$data["business_address"]?></td>
                                            <td class="table-td"><?=$data["pincode"]?></td>
                                            <td class="table-td"><?=$data["dial_code"]?></td>
                                            <td class="table-td"><?=$data["business_phone"]?></td>
                                            <td class="table-td">
                                                <?=
                                            ...
                                            <td class="table-td">
                                                <?=$data["total_credit"] ? $data["total_credit"] : '0'?></td>
                                            <td class="table-td"><?=$data["total_debit"] ? $data["total_debit"] : '0'?>
                                            </td>
                                            <td class="table-td"><?=$data["current_balance"]?></td>
                                            </td>
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="business_modal" tabindex="-1" aria-labelledby="business_modal" aria-hidden="true">
    <!-- BEGIN: Modal -->
    <div class="modal-dialog relative w-auto pointer-events-none">
        <div
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <!-- Modal body -->
                <form method="post" action="<?=URL . admin_link?>/business/change_user_status">
