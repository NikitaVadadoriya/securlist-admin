        ...
        <div class="card xl:col-span-2 mb-4">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Add New State</div>
                    </div>
                </header>
                <div class="card-text h-full">
                    <form class="space-y-4" id="add_state_form">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                            <!-- <div class="input-area relative">
                                ...
                                <p class="text-danger-500 col-12" id="err_countryName"></p>
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="state_modal" tabindex="-1" aria-labelledby="state_modal" aria-hidden="true">
    <!-- BEGIN: Modal -->
                ...
                <form id="ChangeStateStatus">
                    <div class="p-6 space-y-4">
                        <div class="form-group">
                            <input type="hidden" name="sname" id="sname" class="form-control">
    ...
    <div class="modal-dialog relative w-auto pointer-events-none">
        <div
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <div class="jsmodalerror mt-1"></div>
                <form id="EditStateData">
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 gap-7">
                            <!-- <div class="input-area relative">
                                <label for="EditcountryName" class="form-label">Select Country</label>
                                <select name="countryName" id="EditcountryName"
                                    class="select2 form-control w-full mt-2 py-2">
                                    <?php
                                    foreach ($country as $index => $data) {
                                        ?>
