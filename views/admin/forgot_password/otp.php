                    ...
                    <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                        <div class="auth-box h-full flex flex-col justify-center">
                            ...
                            <div class="text-center 2xl:mb-10 mb-4">
                                <h4 class="font-medium">Verify OTP</h4>
                                <div class="text-slate-500 text-base">
                                    Enter OTP which we have sent to <b><?= Session::get('otp_email'); ?></b>
                                </div>
                            </div>
                            <?php $this->check_errors(); ?>
                            <!-- BEGIN: Login Form -->
                            <form class="space-y-4" action="<?=URL . admin_link?>/forgot_password/check_otp"
                                method="post">
                                <div class="fromGroup">
                                    <label for="otp" class="block capitalize form-label">OTP</label>
                                    <div class="relative">
                                        <input type="number" id="otp" name="otp" class="form-control py-2"
                                            placeholder="Enter OTP" required>
                                    </div>
                                </div>
                                <button class="btn btn-dark block w-full text-center" type="submit">Verify</button>
                            </form>
                        </div>
