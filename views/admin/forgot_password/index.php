                ...
                <div class="right-column  relative">
                    <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                        <div class="auth-box h-full flex flex-col justify-center">
                            ...
                            <!-- BEGIN: Login Form -->
                            <form class="space-y-4" action="<?=URL . admin_link?>/forgot_password/otp_send"
                                method="post">
                                <div class="fromGroup">
                                    <label for="email" class="block capitalize form-label">Email</label>
                                    <div class="relative">
                                        <input type="email" id="email" name="email" class="form-control py-2"
                                            placeholder="Enter Email" required>
                                    </div>
                                </div>
                                <button class="btn btn-dark block w-full text-center" type="submit">Send OTP</button>
                            </form>
                        </div>
