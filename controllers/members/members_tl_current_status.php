...
*
*/
class members_tl_current_status extends Controller
{
    public function __construct()
    {
        parent::__construct();
        parent::redirect();
        $this->view->head_file = array('members/tl_current_status/css/tag.php');
        ...
        $this->view->sjs = array('members/tl_current_status/js/default.js');
